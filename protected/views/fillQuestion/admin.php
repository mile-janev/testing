<?php
    ...
    $('.search-form form').submit(function(){
            $.fn.yiiGridView.update('fill-question-grid', {
                    data: $(this).serialize()
            });
            return false;
    });
...
<h2>Менаџирај прашања со дополнување</h2>
		...
		array(
			'class'=>'CButtonColumn',
                        'buttons'=>array(
                                    ...
                                    'delete'=>array(
                                        'url'=>'Yii::app()->createUrl("fillQuestion/delete", array("test_id"=>$data->tests->id, "id"=>$data->id))',
                                    ),
                            ),
		),
	),
