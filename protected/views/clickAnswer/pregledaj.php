<div class="prasanja_test">
    ...
    <?php echo $this->renderPartial('../test/_menupregledaj', array('poeni'=>$poeni, 'fill_num'=>$fill_num, 'complete_num'=>$complete_num)); ?>
</div>
...
<div class="pregledaj_form">
    ...
    <?php
        echo $this->renderPartial('_pregledajform', array('poeni'=>$poeni));
        echo "<br />";
    ?>
    ...
    <?php echo CHtml::button('Продолжи кон прашања со дополнување', array('submit' => array('/fillAnswer/pregledaj&test_id='.$_GET['test_id'].'&student_id='.$_GET['student_id']), 'class'=>'odgovaraj_test')); ?>
</div>