<?php
    ...
    $('.search-form form').submit(function(){
            $.fn.yiiGridView.update('click-question-grid', {
                    data: $(this).serialize()
            });
            return false;
    });
...
<h2>Менаџирај прашања со избор</h2>
		...
		array(
			'class'=>'CButtonColumn',
                        'buttons'=>array(
                                    ...
                                    'delete'=>array(
                                        'url'=>'Yii::app()->createUrl("clickQuestion/delete", array("test_id"=>$data->tests->id, "id"=>$data->id))',
                                    ),
                            ),
		),
	),
