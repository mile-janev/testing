...
/**
 * This is the model class for table "fill_question".
 *
 * The followings are the available columns in table 'fill_question':
 * @property integer $id
 * @property string $question
 * @property string $correct
 * @property integer $test_id
 */
class FillQuestion extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return FillQuestion the static model class
	 */
